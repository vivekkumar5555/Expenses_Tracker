...
import { useLanguageCurrency, languages, currencies } from '../contexts/LanguageCurrencyContext';
  ...
  return (
    <Layout>
      ...
      <div className="space-y-4 lg:space-y-6">
        <h2 className="text-2xl lg:text-3xl font-semibold text-gray-900 dark:text-white">{t('settings.title')}</h2>
        ...
        >
          <h3 className="text-base sm:text-lg font-semibold mb-4 sm:mb-6 text-gray-900 dark:text-white">{t('settings.userPreferences')}</h3>
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 sm:space-y-6">
            <div>
              <label className="block text-sm font-medium mb-2 text-gray-900 dark:text-white">{t('settings.currency')}</label>
            ...
            <div>
              <label className="block text-sm font-medium mb-2 text-gray-900 dark:text-white">{t('settings.language')}</label>
              <div className="relative">
                <select
                  {...register('language')}
                  value={language}
            ...
            <div>
              <label className="block text-sm font-medium mb-2 text-gray-900 dark:text-white">{t('settings.approvalLimit')}</label>
              <input
                type="number"
                step="0.01"
            ...
            <div>
              <label className="block text-sm font-medium mb-2 text-gray-900 dark:text-white">{t('settings.theme')}</label>
              <div className="relative">
                <select
                  {...register('theme')}
                  className="w-full px-3 sm:px-4 py-2.5 sm:py-3 pr-10 rounded-lg bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all text-sm sm:text-base appearance-none cursor-pointer hover:border-gray-400 dark:hover:border-gray-500 shadow-sm"
